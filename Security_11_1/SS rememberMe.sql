CREATE DATABASE  IF NOT EXISTS `security_11_1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `security_11_1`;
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
-- Host: localhost    Database: security_11_1
-- ------------------------------------------------------
...
INSERT INTO `persistent_logins` VALUES ('admin','gxOpX0DvRz5b+KDUAZwWsA==','PpH73MJu1AMIw/6fMrVWZA==','2015-10-31 13:01:52');
...
INSERT INTO `users` VALUES ('admin','admin',1),('chief','chief',1),('guest','guest',1),('user','user',1);
...
-- Dump completed on 2015-10-31 16:11:34
